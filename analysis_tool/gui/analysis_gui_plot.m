    ...
    methods
        ...
        function set_size(obj,a)
            obj.size     = [    a.gui.win_size(1),...
                                a.gui.size_panellabel + 4*a.gui.size_pushbutton(2) + 6*a.gui.size_space];
        end
        ...
        function create_objects(obj,a)
            ...
            item_pos  = [   0.5*obj.size(1) - 0.5*item_size(1) ...
                            obj.size(2) - a.gui.size_panellabel - a.gui.size_space - item_size(2) ];
            obj.objects.plot = uicontrol(...
                'Parent',obj.panel,...
                'Style','pushbutton',...
                'Units','pixel',...
                'Position', [item_pos item_size],...
                'String', {'plot'},...
                'Callback',@a.plot_plot);

            % fig_plot
            item_size   = a.gui.size_pushbutton;
            item_pos(2) = item_pos(2) - a.gui.size_space - item_size(2);
            obj.objects.fig_plot = uicontrol(...
                'Parent',obj.panel,...
                'Style','pushbutton',...
                'Units','pixel',...
                'Position', [item_pos item_size],...
                'String', {'fig_plot'},...
                'Callback',@a.plot_figplot);
            ...
            obj.objects.fig_plot = uicontrol(...
                ...
                'Position', [item_pos item_size],...
                'String', {'fig_barweb'},...
                'Callback',@a.plot_figbarweb);

            % export
            item_size   = a.gui.size_pushbutton;
            item_pos(2) = item_pos(2) - 2*a.gui.size_space - item_size(2);
