    ...
    for i_subject = 1:scan.subject.n
        ...
        if ~scan.glm.pooling
            ...
            for i_run = u_run
                ...
                file_datcon = sprintf('%scondition_sub_%02i_run_%02i.mat',scan.dire.glm.regressor,subject,i_run);
                ...
                % realignment
                file_datrea = sprintf('%srealign_sub_%02i_run_%02i.mat',scan.dire.glm.regressor,subject,i_run);
        ...
        %% SESSIONS (MERGED)
            ...
            % conditions (regressors, modulators & factors)
            file_datcon = sprintf('%smerged_condition_sub_%02i.mat',scan.dire.glm.regressor,subject);
            loadcond = load(file_datcon,'cond');
            for i_cond1 = 1:length(loadcond.cond)
                cond = struct();
                cond.name     = loadcond.cond{i_cond1}.name;
            ...
            % realignment
            file_datrea = sprintf('%smerged_realign_sub_%02i.mat',scan.dire.glm.regressor,subject);
