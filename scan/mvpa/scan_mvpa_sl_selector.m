...
function scan = scan_mvpa_sl_selector(scan)
    ...
    for i_subject = 1:scan.subject.n
        ...
        for i_session=1:n_session, session_sl(i_session, session==mod1(i_session+1,n_session)) = 3; end % for i_session=1:n_session, session_sl(i_session, session==n_session-i_session+1) = 3; end
