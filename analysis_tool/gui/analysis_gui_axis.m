    ...
    methods
        ...
        function set_size(obj,a)
            obj.size     = [    a.gui.win_size(1),...
                                a.gui.size_panellabel + 2*a.gui.size_listbox(2) + 3*a.gui.size_space];
        end
        ...
        function create_objects(obj,a)
            ...
            % x list
            item_pos(1)  = item_pos(1) + item_size(1) + a.gui.size_space;
            item_size(1) = obj.size(1) - 3*a.gui.size_space - item_size(1);
            ...
            item_size = a.gui.size_label;
            item_pos =  [   a.gui.size_space ...
                            item_pos(2) - a.gui.size_space-a.gui.size_label(2) ];
